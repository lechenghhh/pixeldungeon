...
public abstract class Wand extends KindOfWeapon {
	...
	private static final String TXT_WOOD	= "这根薄薄的 %s 魔杖摸起来很暖和。谁知道它用起来会怎么样？";
	private static final String TXT_DAMAGE	= "当这根魔杖被用作近战武器时，它的平均伤害是每次命中 %d 点。";
	private static final String TXT_WEAPON	= "你可以用这个魔杖作为近战武器。";

	private static final String TXT_FIZZLES		= "你的魔杖没电了，现在肯定没电了";
	private static final String TXT_SELF_TARGET	= "你不能瞄准自己";

	private static final String TXT_IDENTIFY	= "你现在对你的 %s 已经足够熟悉了。";
	...
	private static final String UNFAMILIRIARITY		= "unfamiliarity不熟悉的";
	private static final String MAX_CHARGES			= "maxCharges最大费用";
	private static final String CUR_CHARGES			= "curCharges宵禁";
	private static final String CUR_CHARGE_KNOWN	= "curChargeKnown电流已知";
